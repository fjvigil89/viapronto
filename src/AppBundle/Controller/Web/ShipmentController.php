...
class ShipmentController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('shipment_show', array('shipmentid' => $shipment->getShipmentid()));
        }
     ...
     *
     * @Route("/{shipmentid}", name="shipment_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{shipmentid}/edit", name="shipment_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Shipment $shipment)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('shipment_edit', array('shipmentid' => $shipment->getShipmentid()));
        }
     ...
     *
     * @Route("/{shipmentid}", name="shipment_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Shipment $shipment)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('shipment_delete', array('shipmentid' => $shipment->getShipmentid())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
