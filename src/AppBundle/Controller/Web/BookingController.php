...
class BookingController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('booking_show', array('bookingid' => $booking->getBookingid()));
        }
     ...
     *
     * @Route("/{bookingid}", name="booking_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{bookingid}/edit", name="booking_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Booking $booking)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('booking_edit', array('bookingid' => $booking->getBookingid()));
        }
     ...
     *
     * @Route("/{bookingid}", name="booking_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Booking $booking)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('booking_delete', array('bookingid' => $booking->getBookingid())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
